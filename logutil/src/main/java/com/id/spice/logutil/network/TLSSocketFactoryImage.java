...
/**
 * Created by Manas on 27-07-2018.
 */

public class TLSSocketFactoryImage extends SSLSocketFactory {

    private SSLSocketFactory internalSSLSocketFactory;

    public TLSSocketFactoryImage(SSLSocketFactory delegate) throws
